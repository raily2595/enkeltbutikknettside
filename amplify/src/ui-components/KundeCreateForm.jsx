...
import { createKunde } from "../graphql/mutations";
const client = generateClient();
export default function KundeCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAdresse(initialValues.adresse);
    setPostnr(initialValues.postnr);
    setPoststed(initialValues.poststed);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createKunde.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "KundeCreateForm")}
      {...rest}
    >
      <TextField
        label="Navn"
